...
export class PresetAssembler {
  static assemblePrompts(
    ...
    if (language === "zh") {
      ...
      finalUserMessageParts.push("- [Dẫn dắt vào các khu vực chưa biết hoặc mới, kích hoạt sự xuất hiện của các vật phẩm/nhân vật/sự thật quan trọng, tường thuật ngôi thứ ba, trong vòng 15 từ]");
      finalUserMessageParts.push("- [Thể hiện những lựa chọn cảm xúc quan trọng hoặc những thay đổi trong các mối quan hệ giữa các cá nhân, ảnh hưởng đến hướng đi trong tương lai, tường thuật ngôi thứ ba, trong vòng 15 từ]");
      finalUserMessageParts.push("</next_prompts>");
      finalUserMessageParts.push("");
      finalUserMessageParts.push("<events>");
      finalUserMessageParts.push("[Sự kiện cốt lõi 1, tuyên bố ngắn gọn] --> [Sự kiện cốt lõi 2, tuyên bố ngắn gọn] --> [Sự kiện cốt lõi 3, tuyên bố ngắn gọn] --> [Sự kiện cốt lõi 4, tuyên bố ngắn gọn] --> [...]");
      finalUserMessageParts.push("</events>");
      finalUserMessageParts.push("</output>");
      finalUserMessageParts.push("");
